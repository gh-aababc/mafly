...
var index_config_default = {
 ...
 t4: {list: [
    {name: "✈️TG频道@flymaf",
      ...
      {name: "📡裤佬IPTV直播",
      address: "https://seep.eu.org/https://kl.maflya.com"},
      {name: "📡快手直播源-[实时抓取]",
      address: "https://seep.eu.org/https://ks.kl.maflya.com"},
      {name: "📡Twitch直播源-[实时抓取]",
      address: "https://seep.eu.org/https://tw.kl.maflya.com"},
      {name: "📡抖音直播源-[实时抓取]]",
      address: "https://seep.eu.org/https://dy.kl.maflya.com"},
      {name: "🍟YouTube直播-[实时抓取]]",
